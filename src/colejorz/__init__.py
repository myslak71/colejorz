...
def get_pilothouse(request):
    """Return the pilothouse instance."""
    return request.registry.pilothouse
...
def serve(**settings):
    ...
    config.registry.pilothouse = Pilothouse()
    config.add_request_method(get_pilothouse, name='pilothouse', property=True, reify=True)
